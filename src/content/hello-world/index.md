...
O blog é construído com [Astro](https://astro.build) e hospedado no GitHub Pages. Posts são arquivos Markdown em um repositório git — sem CMS, sem banco de dados. Cada post tem sua própria pasta com imagens e arquivos de suporte colocalizados.
